...
<section class=" uk-cover-container uk-position-relative uk-flex uk-flex-bottom uk-background-norepeat uk-background-cover uk-background-top-center uk-background-fixed" uk-height-viewport data-src="{{asset('uploads/banners/'.$data->banner)}} " alt="" uk-img>
    ...
    <div class="uk-position-bottom-left uk-padding-large" uk-scrollspy="target: ul,h2,p; cls: uk-animation-slide-top-medium; delay: 800;">
        <ul class="uk-breadcrumb">
            ...
            <li><span class="text-secondary uk-text-bold">{{ strtoupper($data->activity_parent) }}</span></li>
        </ul>
...
<section class="uk-section bg-pattern">
    <div class="uk-container">
        <div class="" uk-scrollspy="target: h2,p; cls: uk-animation-slide-top-medium; delay: 200;">
            <h2 class="text-secondary">{{ $data->sub_title }}</h2>
            <p class="text-black  uk-text-justify uk-margin-bottom">{!! $data->content !!}</p>
        </div>
    </div>
</section>
