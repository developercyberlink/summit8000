...
<a href="{{ url('admin/trip/'.Request::segment(3).'/index') }}" class="btn btn-default btn-sm backlink"><i class="fa fa-list" aria-hidden="true"></i> Show List </a>
@endsection

@section('content')
<form class="form-horizontal" role="form" action="{{url('admin/trip/'.Request::segment(3).'/'.Request::segment(4).'/update')}}" method="post" enctype="multipart/form-data">
  {{ csrf_field() }}    
  ...
  <div class="col-md-9">
    ...
    <div class="panel">
      <div class="panel-heading">
        <span class="panel-title"> New Trip Info </span>
      </div>
    ...
    <div class="panel">
      ...
      <div class="panel-body">
        <div class="form-group">
          <div class="col-lg-12">
            <div class="bs-component">
              <textarea class="form-control my-editor" id="" name="description" rows="3">{{$data->description}}</textarea>
            </div>
          </div>
        </div>
      </div>
