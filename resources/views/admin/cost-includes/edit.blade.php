...
<form class="form-horizontal" role="form" action="{{route('admin.testimonials.update',['admin'=>$trip_id,'testimonial'=>$data->id])}}" method="post">
@csrf
@method('PUT')     
 ...
 <div class="col-md-9">
  ...
  <div class="panel">
    <div class="panel-heading">
      <span class="panel-title">Edit Cost Includes </span>
    </div>
